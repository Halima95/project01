...
almadinah = City.create(name: "Almadinah", image: "http://www.travelnostop.com/wp-content/uploads/2018/01/9108_saudi_arabia_medina_al-masjid_al-nabawi_thumbnails-610x366.jpg")
...
alaan= Place.create(name: "Alāan Artspace", location: "https://goo.gl/maps/bxqqmoXwp5w", city_id: riyadh.id, image: "http://alaanart.com/uploads/crop_image/428/383/20140409223715_aboutalaan.png?x=-56&y=-101&w=683&o=428?")

almiftaha = Place.create(name: "AlMiftaha village", location: "https://goo.gl/maps/nH1PtaGSH1p", city_id: abha.id, image: "https://www.almowaten.net/wp-content/uploads/2018/09/AF964EF6-B2D8-4648-9F08-3CC5D9C6C7FA-697x800.jpeg")
...
diving = Activity.create(type_of: "Dammam Diving Center", description: "Provided a very special services and traning packages with excellent instructors.", age_rating: "20+", gender: "Male", place_id: dive.id, category_id: (Category.find_by(name: "Diving").id))
